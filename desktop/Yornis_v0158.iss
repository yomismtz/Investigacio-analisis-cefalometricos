...
OutputBaseFilename=Yornis_Setup_v0.15.8_Final_Polish_HiDPI
...
VersionInfoDescription=Instalador final de Yornis · Yom Dental Análisis
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion={#MyAppVersion}
VersionInfoVersion=0.15.8.0
