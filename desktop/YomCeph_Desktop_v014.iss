...
#define MyAppVersion "0.14.0 Classic Research Suite"
#define MyAppExeName "YomCeph_Desktop.exe"

[Setup]
AppId={{E2ECA52A-5360-4B30-86E9-C8BA3F9D0140}
AppName={#MyAppName}
...
OutputDir=..\dist-installer-v014
OutputBaseFilename=YomCeph_Desktop_Setup_v0.14.0_Classic_Research_Suite
