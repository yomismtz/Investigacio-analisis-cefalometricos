...
AppPublisherURL=https://yomismtz.github.io/Investigacio-analisis-cefalometricos/
AppSupportURL=https://github.com/yomismtz/Investigacio-analisis-cefalometricos/issues
DefaultDirName={localappdata}\Programs\Yornis
DefaultGroupName=Yornis
DisableProgramGroupPage=yes
OutputDir=..\dist-installer-yornis
OutputBaseFilename=Yornis_Setup_v0.15.5_Final_Hardening_HiDPI
...
VersionInfoVersion=0.15.5.0
VersionInfoCompany=Yom Dental Análisis
VersionInfoDescription=Yornis Setup
VersionInfoProductName=Yornis
VersionInfoProductVersion=0.15.5
