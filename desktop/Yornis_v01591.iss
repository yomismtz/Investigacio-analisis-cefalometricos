...
OutputBaseFilename=Yornis_Setup_v0.15.9.1_Layout_Hotfix_Bird_Chorus_HiDPI
...
VersionInfoDescription=Instalador de Yornis · Layout Hotfix · Bird Chorus · Yom Dental Análisis
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion={#MyAppVersion}
VersionInfoVersion=0.15.9.1
