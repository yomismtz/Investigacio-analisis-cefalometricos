...
# DPI awareness must be enabled before the first Tk window is created.
import yornis_display_v0152 as display

display.enable_windows_dpi_awareness()
...
class Launcher(base.Launcher):
    def __init__(self):
        ...
        display.apply_display_quality(self, launcher=True)
